...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig completedDaoConfig;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        completedDaoConfig = daoConfigMap.get(CompletedDao.class).clone();
        completedDaoConfig.initIdentityScope(type);
        ...
        completedDao = new CompletedDao(completedDaoConfig, this);
        ...
        registerDao(Completed.class, completedDao);
    ...
    public void clear() {
        ...
        completedDaoConfig.getIdentityScope().clear();
